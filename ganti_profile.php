...
if(isset($_POST['simpan'])){
    ...
    if($password != ''){ //jika akan melakukan perubahan pasword
       $sql1  = "select * from members where email = '".$SESSION['members_email']."'";
       ...
       if($password != $konfirmasi_password){
           $err   .= "<li>Silakan masukkan password dan konfirmasi yang sama</li>";
       }

       if(strlen($password) < 6){
          $err .= "<li>Panjang karakter yang diizinkan untuk pasword adalah minimal 6 karakter.</li>";
       }
    }

    if(empty($err)){
        $sql1 = "update members set nama_lengkap = '".$nama_lengkap."' where email = '".$SESSION['members_email']."'";
