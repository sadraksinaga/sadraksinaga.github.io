...
function ambil_kutipan($id_tulisan){
    global $koneksi;
    $ql1   = "select * from halaman where id = '$id_tulisan'";
...
function buat_link_halaman($id){
     ...
     $r1    = mysqli_fetch_array($q1);
     $judul = $r1["judul"];
     //http://localhost/website-perpustakaan/halaman.php/8/judul
...
function kirim_email($email_penerima, $nama_penerima,$judul_email,$isi_email){
    ...
    $email_pengirim    = "sinagacalegsadrak@gmail.com";
    ...
    try {
        ...
        $mail->Password   = 'mzdt tlbs mhpa azqh';                               //SMTP password
